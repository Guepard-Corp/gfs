# D6: you emptied, the source inserted: the table stays empty
...
- the clone stays empty
- reported rather than silently refilled

## Running it

```bash
tests/paths/run-all.sh D6          # through the runner
bash tests/paths/D6_local_empty_source_insert/test.sh   # directly
```
