# C5: a locally added column survives source activity and a pull
...
- the locally added column is still there after a pull

## Running it

```bash
tests/paths/run-all.sh C5          # through the runner
bash tests/paths/C5_local_schema_change/test.sh   # directly
```
